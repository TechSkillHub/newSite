import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, shallowRef, toRef, onServerPrefetch, defineAsyncComponent, defineComponent, computed, useSSRContext, mergeProps, unref, Suspense, nextTick, Transition, provide, resolveComponent, withCtx, createTextVNode, toDisplayString, createApp, effectScope, shallowReactive, reactive, getCurrentScope, onErrorCaptured, createVNode, resolveDynamicComponent, isReadonly, toRaw, isRef, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, O as baseURL, P as parseQuery, Q as klona, R as getContext, S as createHooks, j as createError$1, T as hasProtocol, E as joinURL, U as defuFn, V as isScriptProtocol, W as withQuery, X as sanitizeStatusCode, Y as withTrailingSlash, J as withoutTrailingSlash, Z as toRouteMatcher, _ as createRouter$1, M as defu } from '../_/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
