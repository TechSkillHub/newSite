import { defineComponent, ref, mergeProps, unref, useSSRContext, withAsyncContext, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { f as __nuxt_component_0$2, _ as _sfc_main$a, g as _export_sfc } from "../server.mjs";
import { q as queryContent } from "./query-rjsxAzRX.js";
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="typed">${ssrInterpolate(unref(typeValue))}</span><span class="${ssrRenderClass(_ctx.caret + " " + { typing: unref(typeStatus) })}"> </span></div>`);
    };
  }
});
...
const _sfc_main$8 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_FieldButton = _sfc_main$a;
      ...
      _push(ssrRenderComponent(_component_EffectsWriter, {
        array: ["Revolução", "Presença", "Solução"],
        caret: "cursor"
      }, null, _parent));
      _push(` Digital<br> Começa<br> Aqui<span class="text-primary">.</span></h1></div><div class="md:w-[46%] flex flex-col justify-between h-full"><p class="text-justify text-grayTheme">${ssrInterpolate(unref(hero).text)}</p><div class="flex flex-col gap-2 md:items-end mt-8"><!--[-->`);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FieldButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="w-11/12"${_scopeId}>Quero começar minha revolução</span>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "material-symbols:arrow-insert",
              class: "-scale-x-100 text-3xl"
            }, null, _parent2, _scopeId));
            ...
            return [
              createVNode("span", { class: "w-11/12" }, "Quero começar minha revolução"),
              createVNode(_component_Icon, {
                name: "material-symbols:arrow-insert",
                class: "-scale-x-100 text-3xl"
              })
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-grayTheme flex flex-col gap-4 relative py-24" }, _attrs))}><div class="container flex flex-col md:flex-row"><div class="md:w-2/3"><h1 class="text-4xl text-primary font-semibold mb-4">Mais sobre nós...</h1><p class="text-justify"> A TSH surgiu com a visão de oferecer serviços e produtos personalizados, fundamentados em processos e requisitos bem definidos. Essa abordagem garante soluções rápidas e de alta qualidade, acreditamos firmemente em uma fórmula simples para o sucesso: Reduzir o tempo e maximizar os objetivos resulta em menor custo e maior retorno para nossos clientes. Nosso propósito é descomplicar o desenvolvimento de soluções em tecnologia, tornando o processo mais eficiente e acessível para todos os envolvidos. </p></div></div></div>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<span data-v-e475a309>Anos de<br data-v-e475a309>experiência</span></div><div class="flex justify-center items-center gap-4 w-1/3" data-v-e475a309>`);
  _push(ssrRenderComponent(_component_EffectsNumberRotate, {
    endAmount: 73,
    duration: 3,
    suffix: "K",
...
//# sourceMappingURL=index-WnT0FZAW.js.map
