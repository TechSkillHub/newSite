import { u as useFetchData, l as loginUser, s as sendMailNewPassword, _ as _sfc_main$2 } from "./auth.service-CIjcSYbX.js";
import { b as useRouter, c as useModalStore, d as useLoadingStore, _ as _sfc_main$3 } from "../server.mjs";
import { defineComponent, ref, mergeProps, unref, withCtx, isRef, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center gap-8 container" }, _attrs))}><h1 class="text-3xl font-bold text-offWhite uppercase">Área do cliente</h1>`);
...
//# sourceMappingURL=index-C78qljfC.js.map
