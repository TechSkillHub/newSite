...
import { u as useRequestEvent, a as useContentPreview } from "./preview-1rvcWeJv.js";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-MonUtPWd.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-rjsxAzRX.js.map
