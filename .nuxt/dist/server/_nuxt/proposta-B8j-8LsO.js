  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "funil",
        class: "bg-offWhite h-screen overflow-x-hidden flex justify-center items-center"
      }, _attrs))} data-v-d2a2733e><div class="max-w-screen-xl grid grid-flow-col gap-8 items-center h-fit" data-v-d2a2733e><div class="grid grid-flow-row h-full gap-8" data-v-d2a2733e><h1 class="text-5xl title font-semibold uppercase leading-tight" data-v-d2a2733e>Começando a sua <span class="text-primary font-theme font-normal" data-v-d2a2733e>revolução digital</span></h1><h2 class="title text-2xl" data-v-d2a2733e>Funil de Vendas Ideal:</h2><div class="funnel" data-v-d2a2733e><div class="funnel-part" data-v-d2a2733e>SEO, Ads e Redes Sociais</div><div class="funnel-part" data-v-d2a2733e>Site e LandingPage</div><div class="funnel-part" data-v-d2a2733e>WhatsApp</div><div class="funnel-part" data-v-d2a2733e>Venda</div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=proposta-B8j-8LsO.js.map
