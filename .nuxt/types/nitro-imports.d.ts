declare global {
  ...
  const createUser: typeof import('../../server/utils/authSocial')['createUser']
  ...
  const findUserByEmail: typeof import('../../server/utils/authSocial')['findUserByEmail']
  ...
  const refreshGoogleAdsToken: typeof import('../../server/utils/googleAds')['refreshGoogleAdsToken']
  ...
  const sendPasswordResetEmail: typeof import('../../server/utils/mailerSend')['sendPasswordResetEmail']
...
export { findUserByEmail, createUser } from '../../server/utils/authSocial';
export { refreshGoogleAdsToken } from '../../server/utils/googleAds';
export { generateToken, verifyToken } from '../../server/utils/jwt';
export { sendPasswordResetEmail } from '../../server/utils/mailerSend';
export { getUserSession } from '../../server/utils/session';