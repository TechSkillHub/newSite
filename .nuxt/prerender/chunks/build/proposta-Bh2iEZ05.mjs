import { useSSRContext, defineComponent, mergeProps, unref } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/server-renderer/index.mjs';
import { gsap as gsap$2 } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/gsap/dist/gsap.js';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-w-screen-lg grid gap-8 h-fit text-center"><h1 class="text-5xl title uppercase">Proposta Comercial</h1><h1 class="text-3xl title">(Servi\xE7o Oferecido)</h1><h1 class="text-7xl title uppercase text-primary font-bold mt-8">(Cliente)</h1></div></div>`);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "quem-somos",
        class: "bg-offWhite h-screen overflow-x-hidden flex justify-center items-center"
      }, _attrs))}><div class="max-w-screen-lg grid grid-flow-col gap-8 items-center h-fit"><img${ssrRenderAttr("src", unref(_imports_0))} alt="Logo" class="w-80 h-80 logo"><div class="grid grid-flow-row h-full gap-8"><h1 class="text-5xl title font-semibold">Quem \xE9 a <span class="text-primary font-theme font-normal">Tech Skill Hub</span>?</h1><p class="text-2xl"> A <span class="text-primary font-theme">TSH</span> foi criada quando identificamos a dificuldade de diversos setores em se posicionar no digital, assim surgiu nosso nome onde a ideia \xE9 juntar diversas habilidades em um \xFAnico lugar de modo que podemos ajudar nosso clientes em toda a a jornada deles no universo do digital. </p></div></div></div>`);
    };
  }
});
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-9397d3d4><div class="max-w-screen-xl grid grid-flow-col gap-8 items-center h-fit" data-v-9397d3d4><div class="grid grid-flow-row h-full gap-8" data-v-9397d3d4><h1 class="text-5xl title font-semibold uppercase leading-tight" data-v-9397d3d4>Come\xE7ando a sua <span class="text-primary font-theme font-normal" data-v-9397d3d4>revolu\xE7\xE3o digital</span></h1><h2 class="title text-2xl" data-v-9397d3d4>Funil de Vendas Ideal:</h2><div class="funnel" data-v-9397d3d4><div class="funnel-part" data-v-9397d3d4>SEO, Ads e Redes Sociais</div><div class="funnel-part" data-v-9397d3d4>Site e LandingPage</div><div class="funnel-part" data-v-9397d3d4>WhatsApp</div><div class="funnel-part" data-v-9397d3d4>Venda</div></div></div></div></div>`);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "funil01",
        class: "bg-offWhite h-screen overflow-x-hidden flex justify-center items-center text-center"
      }, _attrs))} data-v-d2c84449><div class="max-w-screen-xl grid grid-flow-col gap-8 items-center h-fit" data-v-d2c84449><div class="grid grid-flow-row h-full gap-8" data-v-d2c84449><h1 class="text-5xl title font-semibold uppercase leading-tight" data-v-d2c84449>Come\xE7ando a sua <span class="text-primary font-theme font-normal" data-v-d2c84449>revolu\xE7\xE3o digital</span></h1><div class="funnel" data-v-d2c84449><div class="funnel-part" data-v-d2c84449>SEO</div></div><p data-v-d2c84449>SEO \xE9 um conjunto de t\xE9cnicas e estrat\xE9gias para sites ficarem melhor posicionados nos buscadores,<br data-v-d2c84449> gerar reconhecimento de marca, aumentar o tr\xE1fego e as convers\xF5es.</p><div class="flex gap-4" data-v-d2c84449><div class="bg-gray-300 w-full h-80" data-v-d2c84449></div><div class="bg-gray-300 w-full h-80" data-v-d2c84449></div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=proposta-Bh2iEZ05.mjs.map
