...
import { u as useRequestEvent, a as useContentPreview } from './preview-1rvcWeJv.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-MonUtPWd.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-rjsxAzRX.mjs.map
