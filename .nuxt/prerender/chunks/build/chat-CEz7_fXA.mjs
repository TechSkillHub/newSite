...
import { useSSRContext, defineComponent, ref, mergeProps } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderAttr } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<input type="text" placeholder="Pesquisar ou come\xE7ar uma nova conversa" class="bg-transparent outline-none flex-1 text-sm"></div></div><div class="flex-1 overflow-y-auto space-y-1"><!--[-->`);
  ...
  setup(__props) {
    ...
    const contacts = ref([
      ...
      },
      {
        ...
        name: "Carlos Eduardo",
        avatar: "mdi:user",
        lastMessage: "Vamos marcar aquele caf\xE9",
        time: "Ontem",
        unread: 0
      },
      {
    ...
    const chatMessages = ref({
      2: [
        ...
        {
          id: 1,
          content: "Ol\xE1 Jo\xE3o, tudo bem?",
          timestamp: "10:20",
          senderId: 1,
          // Eu
          received: true,
        ...
        {
          id: 2,
          content: "Tudo \xF3timo! E com voc\xEA?",
          timestamp: "10:21",
          senderId: 2,
          // João
          received: true,
        ...
        {
          id: 3,
          content: "Estou bem tamb\xE9m. Vamos marcar algo para o final de semana?",
          timestamp: "10:25",
          senderId: 1,
          // Eu
          received: true,
      ...
      3: [
        ...
        {
          id: 1,
          content: "Oi Maria, preciso falar com voc\xEA",
          timestamp: "09:10",
          senderId: 1,
          // Eu
          received: true,
      ...
      4: [
        ...
        {
          id: 3,
          content: "Vamos marcar aquele caf\xE9",
          timestamp: "08:40",
          senderId: 4,
          // Carlos
          received: true,
      ...
      5: [
        ...
        {
          id: 2,
          content: "Ol\xE1! Como est\xE3o todos?",
          timestamp: "18:05",
          senderId: 6,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (activeChat.value) {
        ...
        _push(`</div><h1 class="text-3xl font-light mb-3">WhatsApp Web</h1><p class="max-w-md"> Envie e receba mensagens sem precisar manter seu celular conectado. <br>Use o WhatsApp em at\xE9 4 dispositivos conectados e 1 celular ao mesmo tempo. </p></div></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
//# sourceMappingURL=chat-CEz7_fXA.mjs.map
