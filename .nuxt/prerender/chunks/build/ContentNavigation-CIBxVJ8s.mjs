...
import { n as useAsyncData, m as useNuxtApp, k as useRuntimeConfig, o as __nuxt_component_2$1 } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BeD5BxYU.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CdVtnthJ.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CIBxVJ8s.mjs.map
