...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-gray-700 flex flex-col p-8" }, _attrs))}><div class="border-b border-darkTheme pb-8"><h1 class="text-4xl font-bold text-offWhite">Formul\xE1rios</h1></div><div class="flex flex-col pt-8"><div class="flex w-fit gap-1"><button class="${ssrRenderClass([{ "border-b-2 border-primary bg-white ": unref(activeTab) === "dados" }, "py-2 px-4 text-gray-700 rounded-t-md bg-grayTheme"])}"> Dados do contratatante </button><button class="${ssrRenderClass([{ "border-b-2 border-primary bg-white": unref(activeTab) === "briefing" }, "py-2 px-4 text-gray-700 rounded-t-md bg-grayTheme"])}"> Briefing de Identidade Visual </button></div><div class="p-4 bg-white rounded-md rounded-tl-none">`);
...
//# sourceMappingURL=forms-BZBWP2fO.mjs.map
