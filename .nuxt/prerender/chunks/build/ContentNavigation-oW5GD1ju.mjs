import { defineComponent, toRefs, computed, useSlots, useSSRContext, toRef, isRef, h } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/index.mjs';
import { hash } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/ohash/dist/index.mjs';
import { m as useAsyncData, j as useNuxtApp, i as useRuntimeConfig, n as __nuxt_component_2$1 } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-rjsxAzRX.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-MonUtPWd.mjs').then((m) => m.generateNavigation);
...
const ContentNavigation = defineComponent({
  ...
  render(ctx) {
    ...
    const renderLink = (link) => h(__nuxt_component_2$1, { to: link._path }, () => link.title);
...
//# sourceMappingURL=ContentNavigation-oW5GD1ju.mjs.map
