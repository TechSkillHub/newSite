import { _ as __nuxt_component_0 } from './Dados-CgeRF5sA.mjs';
import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/server-renderer/index.mjs';
import './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-gray-700 flex flex-col p-8" }, _attrs))}><div class="border-b border-darkTheme pb-8"><h1 class="text-4xl font-bold text-offWhite">Configura\xE7\xF5es</h1></div><div class="flex flex-col pt-8"><div class="flex w-fit gap-1"><button class="${ssrRenderClass([{ "border-b-2 border-primary bg-white ": unref(activeTab) === "dados" }, "py-2 px-4 text-gray-700 rounded-t-md bg-grayTheme"])}"> Dados do contratatante </button></div><div class="p-4 bg-white rounded-md rounded-tl-none">`);
...
//# sourceMappingURL=create-user-CJ7ahX-j.mjs.map
