...
import { useSSRContext, defineComponent, mergeProps, ref, unref, withCtx, isRef, createTextVNode, createVNode } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/vue/server-renderer/index.mjs';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/forms/ResetPassword.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_FormsResetPassword = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center gap-8 container" }, _attrs))}><h1 class="text-3xl font-bold">Create new password</h1>`);
      _push(ssrRenderComponent(_component_FormsResetPassword, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
//# sourceMappingURL=reset-password-uSkZXv5O.mjs.map
