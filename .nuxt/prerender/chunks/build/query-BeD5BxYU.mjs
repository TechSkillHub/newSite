import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://C:/Users/TechSkillHub/Projetos/tsh.principalSite/node_modules/ohash/dist/index.mjs';
import { k as useRuntimeConfig, l as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CdVtnthJ.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BeD5BxYU.mjs.map
